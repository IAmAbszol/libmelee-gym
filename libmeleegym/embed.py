...
embed_buttons = StructEmbedding(
    ...
    key_map={b.name: b.name for b in LEGAL_BUTTONS},
)
...
embed_controller_default = get_controller_embedding(27)#16)
embed_game_default = make_game_embedding(player_config=dict(with_controller=False))
embed_game_sa2s = make_game_embedding(player_config=dict(with_controller=True))
